...
public class SwaggerConfig {
    ...
    public Docket api(){
        return new Docket(DocumentationType.SWAGGER_2).
                select().
                apis(RequestHandlerSelectors.basePackage("com.bcaf.yagpspringbootrestapi.controller")).
...
//    String licenseUrl) {
    private ApiInfo apiInfo()
    {
        ApiInfo apiInfo = new ApiInfo(
                ...
                new Contact("Yordanka","yordankaagp.com","yordankaandre@gmail.com"),//Contact Name
