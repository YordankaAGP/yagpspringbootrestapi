...
import com.bcaf.yagpspringbootrestapi.core.IService;
import com.bcaf.yagpspringbootrestapi.dto.KategoriBarangDTO;
import com.bcaf.yagpspringbootrestapi.handler.RequestCapture;
import com.bcaf.yagpspringbootrestapi.handler.ResponseHandler;
import com.bcaf.yagpspringbootrestapi.model.KategoriBarang;
import com.bcaf.yagpspringbootrestapi.repo.KategoriBarangRepo;
import com.bcaf.yagpspringbootrestapi.repo.LogRequestRepo;
import com.bcaf.yagpspringbootrestapi.util.CsvReader;
import com.bcaf.yagpspringbootrestapi.util.LogTable;
import com.bcaf.yagpspringbootrestapi.util.LoggingFile;
import com.bcaf.yagpspringbootrestapi.util.TransformDataPaging;
...
//        }
    ...
    public ResponseEntity<Object> findById(Long id, HttpServletRequest request) {
        ...
        try {
            ...
            kbdto = modelMapper.map(kategoriBarang, new TypeToken<KategoriBarangDTO>() {
            }.getType());
    ...
    public ResponseEntity<Object> findByPage(Integer page,
        ...
        try {
            ...
            listKategoriBarangDTO = modelMapper.map(pageKategoriBarang.getContent(), new TypeToken<List<KategoriBarangDTO>>() {
            }.getType());
